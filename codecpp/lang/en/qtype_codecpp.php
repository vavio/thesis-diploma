...
$string['range_text_explanation'] = '';
$string['range_text_help'] = 'Specify range (:) or specific values or excluded values with caret (^) all separated  with comma (,). For example: \'1:5,7,^3\' means [1,2,4,5,7]';
