...
$string['range_text'] = 'Bad range text';
$string['range_text_explanation'] = 'range (:) or specific values or excluded values with caret (^) all separated  with comma (,)';
$string['range_text_explanation_help'] = 'For example: \'1:5,7,^3\' means [1,2,4,5,7]';
