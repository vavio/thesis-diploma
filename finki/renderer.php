...
class qtype_finki_renderer extends qtype_renderer {
    public function formulation_and_controls(question_attempt $qa,
        ...
        //$questiontext = $question->format_newquestiontext($qa, $currenttext);
        ...
        //         html_writer::tag('label', get_string('true', 'qtype_finki'),
        //         array('for' => $trueattributes['id'], 'class' => 'ml-1'));
        // $radiofalse = html_writer::empty_tag('input', $falseattributes) .
        //         html_writer::tag('label', get_string('false', 'qtype_finki'),
        ...
        // $result .= html_writer::tag('div', get_string('selectone', 'qtype_finki'),
        //         array('class' => 'prompt'));
        //
