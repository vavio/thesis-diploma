 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_finki_question extends question_graded_automatically {
    public $rightanswer;
    public $truefeedback;
    ...
    //                 get_string('true', 'qtype_finki'), $fraction));
    //     } else {
    //         return array($this->id => new question_classified_response(0,
    //                 get_string('false', 'qtype_finki'), $fraction));
    //     }
    // }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_finki');
    }
...
class qtype_finki_question_loader {
    protected $question;
    public $qt;
    public $ra;
