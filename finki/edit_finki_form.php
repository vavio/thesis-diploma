 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_finki_edit_form extends question_edit_form {
    /**
    ...
    protected function definition_inner($mform) {
        ...
        //         get_string('correctanswer', 'qtype_finki'), array(
        //         0 => get_string('false', 'qtype_finki'),
        //         1 => get_string('true', 'qtype_finki')));
        //
        // $mform->addElement('editor', 'feedbacktrue',
        //         get_string('feedbacktrue', 'qtype_finki'), array('rows' => 10), $this->editoroptions);
        // $mform->setType('feedbacktrue', PARAM_RAW);
        //
        // $mform->addElement('editor', 'feedbackfalse',
        //         get_string('feedbackfalse', 'qtype_finki'), array('rows' => 10), $this->editoroptions);
